...
#define DUST_SENSOR_DIGITAL_PIN_PM10 4 // DSM501 Pin 2 of DSM501
#define DUST_SENSOR_DIGITAL_PIN_PM25 5 // DSM501 Pin 4 (rouge / red)
#define COUNTRY 1                      // 0. France, 1. Europe, 2. USA/China
#define EXCELLENT "Doskonała"
#define GOOD "Dobra"
#define ACCEPTABLE "Akceptowalna"
#define MODERATE "Średnia"
#define HEAVY "Słaba"
#define SEVERE "Groźna"
#define HAZARDOUS "Niebezpieczna"
...
// Durée de mesure - sample time (ms)
...
void updateAQI() {
  ...
  Serial.print("Koncentracja pyłków => PM2.5: ");
